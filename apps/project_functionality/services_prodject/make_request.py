...
from apps.project_functionality.services_prodject.constants import PAGES_PATH
from apps.project_functionality.services_prodject.typings import T_URL, T_TEXT
